...
public class CadastroProcedimentoLFuncionario extends javax.swing.JFrame {
    UsaProcedimento proce = new UsaProcedimento();
    public CadastroProcedimentoLFuncionario() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroProcedimentoLFuncionario().setVisible(true);
            }
        });
    }
